...
#' \cr\cr
#' More precisely, a group of functions (\code{\link{isStringAnInteger}}, \code{\link{isStringADecimal}}, \code{\link{isStringASciNumber}}, \code{\link{isStringANumber}}) verify if an object of class \code{character} correspond to certain types of number, while \code{\link{isStringADate}} and \code{\link{isStringCanBeADate}} concern its representation of a date.
#' \cr\cr
